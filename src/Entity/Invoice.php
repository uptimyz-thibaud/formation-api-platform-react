 ...
 *  "path"="/invoices/{id}/increment", "controller"="App\Controller\IncrementationController",
 *  "swagger_context"={
...
class Invoice
{
     ...
     * @Assert\Type(type="numeric", message="Le montant de la facture doit être un chiffre!")
     */
    private $amount;
     ...
     * @Groups({"invoices_read", "customers_read"})
     * @Assert\NotBlank(message="Le message de la facture doit être obligatoire")
